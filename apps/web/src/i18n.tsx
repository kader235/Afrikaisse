...
const fr = {
  ...
  'auth.forgotHelp': "Membre de l'équipe : demandez au responsable du restaurant de vous donner un nouveau mot de passe (Administration → Équipe). Propriétaire : contactez GLOBALTECH BUSINESS TD.",
  'common.close': 'Fermer',
  ...
  'loc.billMode': 'Addition',
  'loc.tableCode': 'Code de table',
  'loc.tableCodeHint': 'Exigé avant la première commande QR',
  'floor.title': 'Tables',
  ...
  'nav.menu': 'Menu',
  'menu.title': 'Menu',
  'menu.productsCount': 'plat(s)',
  'menu.tabProducts': 'Plats',
  ...
  'menu.noProduct': 'Aucun plat dans cette catégorie.',
  'menu.addProduct': 'Nouveau plat',
  'menu.editProduct': 'Modifier le plat',
  'menu.archiveProduct': 'Archiver',
  'menu.archiveProductConfirm': 'Le plat disparaîtra du menu. Son historique est conservé.',
  'menu.markSoldOut': 'Épuisé',
  'menu.markAvailable': 'Disponible',
  'menu.markedSoldOut': 'Plat marqué épuisé.',
  'menu.markedAvailable': 'Plat de nouveau disponible.',
  'menu.moveUp': 'Monter',
...
const en: Dictionary = {
  ...
  'auth.forgotHelp': 'Team member: ask the restaurant manager to set a new password for you (Administration → Team). Owner: contact GLOBALTECH BUSINESS TD.',
  'common.close': 'Close',
