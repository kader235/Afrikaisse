...
export const AUDIT_ACTION_LABELS: Record<string, string> = {
  ...
  'auth.recovery_set': 'Question secrète définie',
  'auth.recovery_set_failed': 'Échec de définition de la question secrète',
  'auth.recovered': 'Compte récupéré par la question secrète',
  'auth.recovery_failed': 'Mauvaise réponse à la question secrète',
  'menu.announcement_created': 'Annonce créée',
  'menu.announcement_updated': 'Annonce modifiée',
  'menu.announcement_published': 'Annonce publiée',
  'menu.announcement_unpublished': 'Annonce retirée',
  'menu.announcement_archived': 'Annonce archivée',
