...
const fr = {
  ...
  navSearch: 'Chercher',
  navCart: 'Panier',
  headerLine: 'Menu · Table {label}',
  chooseOptions: 'Choisir les options',
  featured: 'À la une',
  activeOrders: '{n} commande(s) en cours',
  announcements: 'Annonces',
  announcementNo: 'Annonce {n}',
  memoInviteTitle: 'Votre commande est en préparation',
  memoInviteBody: 'Un petit jeu en attendant ?',
  memoPlay: 'Jouer',
  memoTitle: 'Jeu du mémo',
  memoIntro: 'Retournez les cartes deux par deux et retrouvez les paires.',
  memoMoves: 'Coups',
  memoPairs: 'Paires',
  memoTime: 'Temps',
  memoReady: 'Votre commande est prête',
  memoWin: 'Bravo ! Trouvé en {n} coups',
  memoWinTime: 'Toutes les paires en {time}.',
  memoReplay: 'Rejouer',
  memoCardHidden: 'Carte {n}, cachée',
  memoCardShown: 'Carte {n} : {name}',
  memoCardFound: 'Carte {n} : {name}, paire trouvée',
  memoIllustration: 'dessin {n}',
};
...
const en: Record<MenuKey, string> = {
  ...
  featured: 'Featured',
  activeOrders: '{n} order(s) in progress',
  announcements: 'Announcements',
  announcementNo: 'Announcement {n}',
  memoInviteTitle: 'Your order is being prepared',
  memoInviteBody: 'A little game while you wait?',
  memoPlay: 'Play',
  memoTitle: 'Memory game',
  memoIntro: 'Flip the cards two at a time and find the pairs.',
  memoMoves: 'Moves',
  memoPairs: 'Pairs',
  memoTime: 'Time',
  memoReady: 'Your order is ready',
  memoWin: 'Well done! Found in {n} moves',
  memoWinTime: 'All pairs in {time}.',
  memoReplay: 'Play again',
  memoCardHidden: 'Card {n}, hidden',
  memoCardShown: 'Card {n}: {name}',
  memoCardFound: 'Card {n}: {name}, pair found',
  memoIllustration: 'drawing {n}',
};
...
const ar: Record<MenuKey, string> = {
  ...
  navSearch: 'بحث',
  navCart: 'السلة',
  headerLine: 'القائمة · طاولة {label}',
  chooseOptions: 'اختر الخيارات',
  featured: 'مميز',
  activeOrders: '{n} طلبات قيد التنفيذ',
  announcements: 'الإعلانات',
  announcementNo: 'إعلان {n}',
  memoInviteTitle: 'طلبك قيد التحضير',
  memoInviteBody: 'لعبة صغيرة في أثناء الانتظار؟',
  memoPlay: 'العب',
  memoTitle: 'لعبة الذاكرة',
  memoIntro: 'اقلب البطاقات اثنتين اثنتين وابحث عن الأزواج.',
  memoMoves: 'المحاولات',
  memoPairs: 'الأزواج',
  memoTime: 'الوقت',
  memoReady: 'طلبك جاهز',
  memoWin: 'أحسنت! وجدتها في {n} محاولة',
  memoWinTime: 'كل الأزواج في {time}.',
  memoReplay: 'العب مجددًا',
  memoCardHidden: 'البطاقة {n}، مقلوبة',
  memoCardShown: 'البطاقة {n}: {name}',
  memoCardFound: 'البطاقة {n}: {name}، زوج مكتمل',
  memoIllustration: 'رسم {n}',
};
