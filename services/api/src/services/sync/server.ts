...
const LOCATION_TABLES = ['zones', 'dining_tables', 'qr_codes', 'stations', 'menu_categories', 'modifier_groups', 'modifiers', 'products', 'product_variants', 'product_modifier_groups', 'printers', 'inventory_items', 'recipe_items', 'pricing_settings', 'tax_rates', 'promotions'];
