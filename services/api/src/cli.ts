 ...
 */
const USAGE = 'Usage : cli migrate | grant-platform-admin <e-mail> | revoke-platform-admin <e-mail> | release-keygen | release-sign <manifeste.json> | release-publish <manifeste.signe.json>';
